...
window.QUIZ_CONFIG = {
  ...
  // リアクションに使う絵文字。1つの投稿につき1人1つまで。
  // ここを書き換えれば並び順も種類も変えられます（好きな絵文字でOK）。
  reactions: ['❤️', '🤣', '👏', '🤔', '💡', '😮', '🔥', '🙏'],
  ...
  points: {
    ...
    solve: 1,            // クイズを1問解く（その問題をはじめて解いたとき）
    correct: 1,          // 正解ボーナス（その問題にはじめて正解したとき・何回目でもよい）
    create: 10,          // 作問（1問作る）
    comment: 2,          // コメントを書く
    commentReceived: 3,  // 自分の問題にコメントが付く
    // リアクションは種類を問わず対象（♥でも🤣でも、どの絵文字でも）。
    // 1つの問題につき1人1つまで数えます。
    goodGiven: 1,        // 問題にリアクションを押す
    goodReceived: 5,     // 自分の問題にリアクションが付く
    cmtReactGiven: 1,    // コメントにリアクションを押す
    cmtReactReceived: 3, // 自分のコメントにリアクションが付く
